import { ConversionResponse, Convert, Currency, ResultConvert } from '@Interfaces/interfaces';
...
export class CurrencyService {
  ...
  private _historyConvert: ResultConvert[] = [];
  ...
  get getHistory() {
    return this._historyConvert;
  }
  AddToTheHistory(Convertion: ResultConvert) {
    this._historyConvert.push(Convertion);
  }
  getConvert(convert: Convert) {
    return this.http.get<ConversionResponse>(`${environment.baseUrl}/${convert.from.CurrencyCode}/${convert.to.CurrencyCode}/${convert.amount}`)
  }
